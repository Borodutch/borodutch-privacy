...
v-app
  v-main
    .v-container.pa-4
      v-layout(column)
        h2
          | {{ "Common Privacy Policy of projects listed at " }}
          a(href='https://borodutch.com') borodutch.com
          | .
        p Project operates the website listed at borodutch.com, which provides the SERVICE.
        p This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the website.
        ...
        p Our website uses these "cookies" to collect information and to improve our Service. You have the option to either accept or refuse these cookies, and know when a cookie is being sent to your computer. If you choose to refuse our cookies, you may not be able to use some portions of our Service.
        ...
        p
          ...
          a(href='mailto:privacy@borodutch.com') privacy@borodutch.com
          | .
</template>
